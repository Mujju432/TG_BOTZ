...
API_ID = int(environ.get('API_ID', '23917789'))
API_HASH = environ.get('API_HASH', 'b00d1a476510461781231f5ebf8b5e10')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6643337452').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1001940407124').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sunildatta377:mujju700@cluster0.lyo09bp.mongodb.net/?retryWrites=true&w=majority")
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'VsIjh8aWX4NTBQ0vzq1vqNRpEGH2')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001953047979'))
